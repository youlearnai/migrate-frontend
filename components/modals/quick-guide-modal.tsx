...
const useSteps = (): Step[] => {
  ...
  return [
    ...
    {
      title: t("newFeature.steps.websites.title"),
      description: t("onboarding.steps.websites.description"),
      media: "https://dj2sofb25vegx.cloudfront.net/signup_modal/websites.mp4",
      mediaType: "video",
    },
    {
    ...
    },
    {
      ...
      media: "https://dj2sofb25vegx.cloudfront.net/signup_modal/flashcards.mp4",
      mediaType: "video",
    },
    {
    ...
    {
      title: t("newFeature.steps.summaryPrompts.title"),
      description: t("newFeature.steps.summaryPrompts.description"),
      media:
        "https://dj2sofb25vegx.cloudfront.net/signup_modal/summary_prompts.mp4",
      mediaType: "video",
    },
    {
    ...
    {
      title: t("newFeature.steps.flashcards.title"),
      description: t("onboarding.steps.flashcards.description"),
      media:
        "https://youlearn-content-uploads.s3.amazonaws.com/feature_modal/voice_mode.mp4",
      mediaType: "video",
    },
    {
    ...
    {
      title: t("newFeature.steps.settings.title"),
      description: t("newFeature.steps.settings.description"),
      media:
        "https://dj2sofb25vegx.cloudfront.net/signup_modal/profile_settings.mp4",
      mediaType: "video",
    },
  ];
};
...
export default function QuickGuideModal() {
  ...
  const isModalOpen = isOpen && type === "quickGuide";
